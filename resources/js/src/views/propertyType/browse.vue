        ...
        <vx-card ref="properties" title="Properties List" collapse-action refreshContentAction @refresh="getProperties">
            <vs-table search :data="properties">
                <template slot="header">
                    ...
                    <vs-button size="small" to="/dashboard/propertyType/create" icon-pack="feather" icon="icon-plus" type="filled">Create Property</vs-button>
                </template>
                <template slot="thead">
                    <vs-th>#</vs-th>
                    <vs-th sort-key="title">Property Type</vs-th>
                ...
                <template slot-scope="{data}">
                    <vs-tr :key="index" v-for="(record, index) in data">
                        ...
                        <vs-td :data="record.property_type">
                            ...
                            <vs-row>
                                <div class="flex mb-4">
                                    ...
                                    <vx-tooltip class="mr-5" color="warning" text="Edit Record">
                                        <vs-button :to="`/dashboard/propertyType/${record.id}/edit`" radius color="warning" type="border" icon-pack="feather" icon="icon-edit"></vs-button>
                                    </vx-tooltip>
    ...
    export default {
        ...
        methods: {
            ...
            deleteRecord(params)
            {
                ...
                this.$store.dispatch('property/deletetype', params[0].id)
                    .then(response => {
