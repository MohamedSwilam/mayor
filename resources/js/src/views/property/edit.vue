        ...
        <div class="vx-col w-full mb-base">
            <vx-card ref="edit" title='Edit Property'>
                ...
                <vs-row vs-justify="center" vs-align="center">
                    <vs-button id="btn-edit" class="vs-con-loading__container" :disabled="!validateForm" @click="is_requesting?$store.dispatch('viewWaitMessage', $vs):edit()" icon-pack="feather" icon="icon-save">Save Property</vs-button>
                </vs-row>
            </vx-card>
        </div>
    </div>
