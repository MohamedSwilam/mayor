...
/* harmony default export */ __webpack_exports__["default"] = ({
  computed: {
    ...
    user_displayName: function user_displayName() {
      return this.$store.getters['auth/userData'] ? "".concat(this.$store.getters['auth/userData'].first_name, " ").concat(this.$store.getters['auth/userData'].last_name) : '';
    },
            ...
            [
              _c("div", { staticClass: "con-img ml-3" }, [
                _c("img", {
                  ...
                  attrs: {
                    src: __webpack_require__(/*! @assets/images/portrait/small/avatar-s-11.jpg */ "./resources/assets/images/portrait/small/avatar-s-11.jpg"),
                    alt: "user-img",
                    width: "40",
                    height: "40"
                  }
        ...
        [
          _c("vx-auto-suggest", {
            ...
            attrs: {
              ...
              icon: "SearchIcon",
              placeholder: "Search mayor dashboard"
            },
            on: {
              input: _vm.hnd_search_query_update,
              selected: _vm.selected,
                  ...
                  _c(
                    ...
                    [
                      _c("img", {
                        ...
                        attrs: {
                          alt: "logo",
                          src: __webpack_require__(/*! @assets/images/logo/logo-small.png */ "./resources/assets/images/logo/logo-small.png")
                        }
                      }),
                      _vm._v(" "),
                      _vm.title
                        ? _c(
                            "span",
                            {
                              ...
                              staticClass: "vx-logo-text text-dark ml-5"
                            },
              ...
              _c(
                ...
                [
                  _vm._l(_vm.menuItemsUpdated, function(item, index) {
                    return _vm.can(item.permission) || !item.permission
                      ? [
...
/***/ "./resources/assets/images/logo/logo-small.png":
/*!*****************************************************!*\
  !*** ./resources/assets/images/logo/logo-small.png ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "/images/logo-small.png?c49ad67162128a77d4d4cacb81d25122";
